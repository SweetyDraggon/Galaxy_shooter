...
public class UbhRandomSpiralMultiShot : UbhBaseShot
{
	private sealed class _ShotCoroutine_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			{
			case 0u:
				if (this._this._BulletNum <= 0 || this._this._RandomSpeedMin <= 0f || this._this._RandomSpeedMax <= 0f || this._this._SpiralWayNum <= 0)
				{
				...
				this._wayAngle___0 = 360f / (float)this._this._SpiralWayNum;
			...
			case 1u:
				...
				this._centerAngle___3 = this._this._StartAngle + this._wayAngle___0 * (float)this._wayIndex___0 + this._this._ShiftAngle * Mathf.Floor((float)(this._i___1 / this._this._SpiralWayNum));
			...
			{
				if (this._this._SpiralWayNum > this._wayIndex___0)
				{
					goto IL_160;
				}
				this._wayIndex___0 = 0;
				if (0f <= this._this._RandomDelayMin && 0f < this._this._RandomDelayMax)
				{
