...
public class Boss2 : MonoBehaviour
{
	private sealed class _SetDie_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			{
			case 0u:
				if (this._this.goShotList.Count >= 2)
				{
	...
	private void MoveDone()
	{
		...
		base.Invoke("Move", UnityEngine.Random.Range(1f, 3f));
	}
	...
	{
		Boss2._SetDie_c__Iterator0 _SetDie_c__Iterator = new Boss2._SetDie_c__Iterator0();
